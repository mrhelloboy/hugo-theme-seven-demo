...
![微服务认证和鉴权涉及到的三种场景](./auth-scenarios.png "微服务认证和鉴权涉及到的三种场景")
...
![采用Token进行用户认证的流程图](https://cdn.auth0.com/content/jwt/jwt-diagram.png "采用Token进行用户认证的流程图")
...
![采用API Gateway实现微服务应用的SSO](./api-gateway-sso.png "采用API Gateway和Token实现微服务应用的单点登录")
